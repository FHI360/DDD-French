...
public class PatientAdpter extends RecyclerView.Adapter<PatientAdpter.ViewHolder> {
    ...
    public PatientAdpter(List<PatientDto> patientList, Context context) {
    ...
    @NonNull
    @Override
    public PatientAdpter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
