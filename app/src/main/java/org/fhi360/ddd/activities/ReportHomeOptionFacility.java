...
public class ReportHomeOptionFacility extends AppCompatActivity {
    ...
    private View menu4;
    private View menu5;
    private View menu6,menu8,menu9;
    ...
    public void menuClick(View view) {
        ...
        if (view.getTag().equals("Liste des clients pour DDD")) {
            Intent intent = new Intent(view.getContext(), AdminPatientList4.class);
            view.getContext().startActivity(intent);
        }
        ...
        if (view.getTag().equals("Rechercher le client")) {
            Intent intent = new Intent(view.getContext(), PatientByDateRange.class);
            view.getContext().startActivity(intent);
        }
        if (view.getTag().equals("Client assigné")) {
            Intent intent = new Intent(view.getContext(), FacilityPatientList3.class);
            view.getContext().startActivity(intent);
        }
