        ...
        objectCall.enqueue(new Callback<Response>() {
            ...
            public void onResponse(@NonNull Call<Response> call, @NonNull retrofit2.Response<Response> response) {
                if (response.isSuccessful()) {
                    mPb.hide();
                    FancyToast.makeText(ClientProfileActivity.this, "Client retiré du service", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, false).show();
                } else {
                    mPb.hide();
                    FancyToast.makeText(ClientProfileActivity.this, "Erreur système contacter l'administrateurr", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
            ...
            public void onFailure(@NonNull Call<Response> call, @NonNull Throwable t) {
                t.printStackTrace();
                FancyToast.makeText(ClientProfileActivity.this, "Pas de connexion Internet", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                mPb.hide();
            }
