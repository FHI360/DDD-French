...
public class PatientByDateRange extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        to.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final DatePickerDialog mDatePicker = new DatePickerDialog(PatientByDateRange.this, to1, myCalendar
        ...
        from.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final DatePickerDialog mDatePicker = new DatePickerDialog(PatientByDateRange.this, from1, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH));
                mDatePicker.show();
            }
    ...
    public void getPatient(String start, String end) {
        ProgressDialog mPb = new ProgressDialog(PatientByDateRange.this);
        mPb.setProgress(0);
        ...
        Long id = DDDDb.getInstance(PatientByDateRange.this).facilityRepository().getFacility().getId();
        ClientAPI clientAPI = APIService.createService(ClientAPI.class);
        Call<Data> objectCall = clientAPI.getAllPatientsByDateRange(start, end, id);
        objectCall.enqueue(new Callback<Data>() {
            ...
            public void onResponse(@NonNull Call<Data> call, @NonNull retrofit2.Response<Data> response) {
                if (response.isSuccessful()) {
                    ...
                    patientRecyclerAdapter = new PatientAdpter2(listPatients, PatientByDateRange.this);
                    RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(PatientByDateRange.this);
                    ...
                    FancyToast.makeText(PatientByDateRange.this, "DDD ne peut pas obtenir les dossiers des patients", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                    mPb.hide();
                }
            ...
            public void onFailure(@NonNull Call<Data> call, @NonNull Throwable t) {
                t.printStackTrace();
                FancyToast.makeText(PatientByDateRange.this, "Pas de connexion Internet", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                mPb.hide();
            }
