...
public class PatientAdpter3 extends RecyclerView.Adapter<PatientAdpter3.ViewHolder> {
    ...
    public PatientAdpter3(List<PatientDto> patientList, Context context) {
    ...
    @NonNull
    @Override
    public PatientAdpter3.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, FacilityClientProfile.class);
    ...
    private void savePreferences(PatientDto patient) {
